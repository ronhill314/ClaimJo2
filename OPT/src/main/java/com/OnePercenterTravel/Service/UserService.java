...
/*
 * The job of the service is do ALL OF YOUR CRUD JAVA LOGIC
...
public class UserService {
    ...
    // YOU ONLY AUTORWIRE THE REPO FOR YOUR OWN ENTITY
    //YOU SHOULD NOT AUTOWIRE ANY SERVICE IN YOUR SERVICE
    @Autowired
    UserRepo userRepo;
    ...
    public User signIn(User user) throws Exception {
        ...
        if(loggedInUser == null) {
            throw new Exception("User not found, tyr again billy");
        }
        return loggedInUser;
    }
    ...
    //UPDATE
                                // Must throw Exception when throwig custom errors
