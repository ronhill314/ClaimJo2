...
<body class="flex-col">
    ...
    <div class="main-content flex-row">
        <div class="signup-box flex-col">
            <h1>Sign Up</h1>
            <!--form:form rags are for spring forms so you can 
            ...
            <div class="flex-row justify-center text-input-margin">
                ...
                <div>Email: </div><form:input path="email" class="text-input" type="email"/>
            </div>
            <div class="flex-row justify-center text-input-margin">
                <!--form:inputs so spring can track your input to a variable-->
                <!--The path represents the variable to set the data to-->
            ...
            <div class="flex-row justify-center text-input-margin">
                <!--form:inputs so spring can track your input to a variable-->
                <!--The path represents the variable to set the data to-->
                <div>Name: </div><form:input path="name" class="text-input" type="name" />
            </div>
